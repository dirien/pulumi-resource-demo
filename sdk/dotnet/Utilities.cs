...
namespace Pulumi.Demo
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Demo.version.txt");
    ...
    internal sealed class DemoResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public DemoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
